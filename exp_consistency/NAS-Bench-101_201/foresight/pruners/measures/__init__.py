...
def load_all():
    ...
    from . import size
    from . import synflow
    from . import grad_conflict
    from . import grad_angle
    from . import params
    from . import flops
    from . import effective_capacity
    from . import te_score
    from . import zen_score
    from . import effective_gradnorm
    from . import effective_snip
    from . import effective_grasp
    from . import ntktrace
    from . import effective_ntktrace
    from . import zico
    from . import effective_zico
    from . import effective_gradsign
